import type { EventSubscription, SourceEvent, WatchEventsOptions } from "./types.js";
...
export declare function watchSourceEvents(input: WatchSourceEventsInput): EventSubscription;
